...
3. Browsing the Websites grants you a personal, revocable, non-exclusive
   ...
   nothing more. No other IP right is granted by implication.

## Open source

Our published open-source products are governed by their own repository
licences (MIT). The licence in each repository is the complete statement
of your rights in that code; these Terms neither add to nor subtract from
it.
...
email [hello@cuesoft.io](mailto:hello@cuesoft.io) with: (a) the material
and where it appears (URL); (b) the right you hold and proof of it;
(c) your contact details; and (d) a statement that your notice is accurate
and made in good faith. We review every notice, remove or restore material
as the facts warrant, and respond to the notifier. Misrepresenting an
infringement claim can make you liable for the costs it causes.
