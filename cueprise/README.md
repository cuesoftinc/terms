...
3. Cuesoft may suspend access that presents a security risk, exceeds the
   licensed scope, or breaches these Platform Terms, and will restore it
...
1. **Cueprise™ and all Cuesoft platforms remain Cuesoft's exclusive
   ...
   for use without restriction or fee).
2. Support hours, response targets, maintenance windows, updates and
   version policy are as stated in the licensing agreement.
...
[jurisdiction](../jurisdictions/nigeria/) sections of these Terms fill the
gap.

## Contact

Cueprise™ licensing and platform questions:
